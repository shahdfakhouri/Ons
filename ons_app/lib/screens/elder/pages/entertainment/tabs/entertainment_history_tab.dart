...
class EntertainmentHistoryTab extends StatefulWidget {
  const EntertainmentHistoryTab({super.key});

  @override
  State<EntertainmentHistoryTab> createState() => _EntertainmentHistoryTabState();
}

class _EntertainmentHistoryTabState extends State<EntertainmentHistoryTab> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      history = results[0] as List<dynamic>;
  ...
  Widget build(BuildContext context) {
    ...
    if (history.isEmpty) return const Center(child: Text('No activity yet.'));
